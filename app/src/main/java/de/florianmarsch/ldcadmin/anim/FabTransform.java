package de.florianmarsch.ldcadmin.anim;
...
/*
        import de.florianmarsch.ldcadmin.anim.unused.AnimUtils;
...
public class FabTransform extends Transition {
    ...
    public Animator createAnimator(final ViewGroup sceneRoot,
        ...
        final View button = startValues.view;
        final Rect dialogBounds = fromFab ? endBounds : startBounds;
        final Rect fabBounds = fromFab ? startBounds : endBounds;
        final Interpolator fastOutSlowInInterpolator = AnimationUtils.loadInterpolator(sceneRoot.getContext(),
        ...
        if (fromFab) {
            ...
            circularReveal = ViewAnimationUtils.createCircularReveal(view,
                    ...
                    endBounds.width() / 2);
            circularReveal.setInterpolator(AnimationUtils.loadInterpolator(sceneRoot.getContext(),
